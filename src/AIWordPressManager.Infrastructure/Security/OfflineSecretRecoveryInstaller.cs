...
public sealed class OfflineSecretRecoveryInstaller
{
        ...
        string? localApplicationData = null)
    {
        ...
        // The web host holds this lock for its entire lifetime. Recovery must acquire the same
        // exclusive lease before it is allowed to touch the stable key file.
    ...
    private static string ReadWrappedEnvelope(string backupPath)
    {
