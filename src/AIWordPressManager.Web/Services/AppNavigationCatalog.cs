    ...
    [
        ...
        new(
            ...
            [
                ...
                Item("⚿", "Roles & Permissions", "الأدوار والصلاحيات", "Review the access matrix and assign application roles.", "مراجعة مصفوفة الوصول وتعيين أدوار التطبيق.", "/admin/roles-permissions", "admin roles permissions access authorization", "ادمن ادوار صلاحيات وصول تفويض", administratorOnly: true),
