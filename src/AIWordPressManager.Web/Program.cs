...
builder.Services.AddScoped<ApplicationSecurityAuditStore>();
builder.Services.AddScoped<ApplicationSecurityAuditService>();
builder.Services.AddScoped<SiteOperationMaintenanceService>();
