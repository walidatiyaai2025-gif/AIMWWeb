...
class ContentPlannerRouteTerminalityTest extends TestCase
{
    ...
    public function test_reference_exposes_content_planner_under_authenticated_fallback(): void
    {
        $sourcePath = base_path('../../../src/AIWordPressManager.Web/Components/Pages/ContentPlanner.razor');
        ...
        $program = (string) file_get_contents($programPath);

        $this->assertStringContainsString('@page "/content-planner"', $source);
    ...
    public function test_route_has_no_caller_supplied_resource_identifier_surface(): void
    {
        ...
        $this->assertStringNotContainsString('{planner}', $route->uri());
    }
