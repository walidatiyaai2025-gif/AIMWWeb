...
final class SiteBrainServiceGetAsyncTerminalityTest extends TestCase
{
    ...
    public function test_exact_canonical_operation_is_pending_during_implementation_stage(): void
    {
        ...
        $this->assertSame('SiteBrainService.GetAsync', $operation['service']);
        ...
        $this->assertStringContainsString('GetAsync', $source);
        $this->assertStringContainsString('JsonException', $source);
        $this->assertStringContainsString('Default(siteId)', $source);
    ...
    public function test_missing_profile_returns_source_equivalent_defaults(): void
    {
        ...
        $this->assertNotEmpty($profile['updated_at_utc']);
    }
    ...
    public function test_malformed_json_falls_back_to_default_profile(): void
    {
        [$tenant, $site] = $this->tenantAndSite('alpha');
        $context = app(TenantContext::class);
        $context->activate($tenant);
