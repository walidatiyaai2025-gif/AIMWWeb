...
final class BillingPlan extends Model
{
    ...
    protected function casts(): array { return ['localized_name'=>'array','limits'=>'array','entitlements'=>'array','enabled'=>'boolean','retired_at'=>'datetime','price_minor'=>'integer']; }
    public function subscriptions(): HasMany { return $this->hasMany(TenantSubscription::class); }
    public function commerciallyConfigured(): bool { return $this->code==='free-trial'||($this->price_minor!==null&&filled($this->provider_plan_id)); }
}
