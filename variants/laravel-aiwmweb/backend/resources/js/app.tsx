...
function RouteElement({ route }: { route: WorkspaceRoute }) {
    ...
    if (route.key === 'comments') return <><CommentsBackToSitesControl context={context} /><CommentsBackToExplorerControl context={context} /><CommentsCommentLinksControl context={context} /><CommentsContentHubLink context={context} /><CommentsManageSiteControl context={context} /><WorkspacePage context={context} route={route} /></>;
